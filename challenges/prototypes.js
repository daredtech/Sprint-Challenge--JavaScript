...
// Task: You are to build a cuboid maker 
// that can return values for a cuboid's volume or surface area. 
...
*/
function CuboidMaker (makerparam) {
	this.length = makerparam.length;
	this.width = makerparam.width;
	this.height = makerparam.height;
}

/* == Step 2: Volume Method ==
  Create a method using CuboidMaker's prototype 
  that returns the volume of a given cuboid's length, width, and height
